    ...
    if request.method == "OPTIONS": # CORS preflight
        ...
        try: 
            ...
            if 'chat_id' in jjson.keys() and jjson['chat_id'] != 0:
                ...
                print(f"XX chat_id: "+jjson['chat_id']+" ")
...
def _corsify_actual_response(response):
    # response.headers.add("Access-Control-Allow-Origin", "*")
    response.headers.add("Access-Control-Allow-Origin", "https://chatai2.3dmemories.eu")
    return response
...
if __name__ == '__main__':
   ...
   llm = ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0.9, stop = "<END_OF_TURN>")
